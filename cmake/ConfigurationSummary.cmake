...
if(EYE_DATA)
    file(APPEND ${OUTFILE} "eye_data: ${EYE_DATA}\n")
else()
    file(APPEND ${OUTFILE} "eye_data: ${CMAKE_SOURCE_DIR}/data/eye\n")
endif()
if(EYE_MODEL)
    file(APPEND ${OUTFILE} "eye_model: ${EYE_MODEL}\n")
else()
    file(APPEND ${OUTFILE} "eye_model: ${CMAKE_SOURCE_DIR}/ritnet-fused.onnx\n")
endif()
