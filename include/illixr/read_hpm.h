...
inline void read_counters(double* read_counters) {
    ...
    read_counters[0] = read_csr(hpmcounter3); 
    read_counters[1] = read_csr(hpmcounter4); 
    read_counters[3] = read_csr(hpmcounter5); 
    read_counters[4] = read_csr(hpmcounter6); 
    read_counters[5] = read_csr(hpmcounter7); 
    read_counters[6] = read_csr(hpmcounter8); 
    read_counters[7] = read_csr(hpmcounter9); 
    read_counters[9] = read_csr(hpmcounter10); 
    // read_counters[10] = read_csr(hpmcounter11); 
    // read_counters[12] = read_csr(hpmcounter12); 
    read_counters[13] = read_csr(cycle); 
    read_counters[14] = read_csr(instret); 
}
